...
void setBeacon() {
  ...
  oAdvertisementData.setCompleteServices(BLEUUID(beconUUID));
    ...
    beacon_data[2] = 0x01;  // URL Scheme 'https://www.'
    beacon_data[3] = 'i';  // URL add  1
    beacon_data[4] = 'e';  // URL add  2
    beacon_data[5] = 'r';  // URL add  3
    beacon_data[6] = '.';  // URL add  4
    beacon_data[7] = 'u';  // URL add  5
    beacon_data[8] = 'n';  // URL add  6
    beacon_data[9] = 'a';  // URL add  7
    beacon_data[10] = 'm';  // URL add  8
    beacon_data[11] = '.';  // URL add  9
    beacon_data[12] = 'm';  // URL add 10
    beacon_data[13] = 'x';  // URL add 11
    beacon_data[14] = '/';  // URL add 12
    beacon_data[15] =  0 ;  // URL add 13
